...
export default function Footer() {
  return (
    <footer className="bg-linear-to-br from-emerald-950 via-slate-900 to-slate-950 text-white pt-20 pb-10 px-4 md:px-12 border-t border-emerald-900/30">
      <div className="max-w-6xl mx-auto flex flex-col items-center text-center">
        ...
        <div className="mb-8">
            ...
            <p className="text-xs text-emerald-400 tracking-[0.2em] mt-1">WHERE COMFORT MEETS CARE</p>
        </div>
        ...
        <div className="flex gap-6 mb-12">
            {[Facebook, Twitter, Instagram].map((Icon, i) => (
                <a key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 hover:bg-emerald-600 flex items-center justify-center transition-all duration-300 hover:scale-110">
                    <Icon size={18} />
                </a>
            ))}
        </div>
